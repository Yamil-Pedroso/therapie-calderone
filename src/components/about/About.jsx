  ...
  return (
    <Container style={{marginTop:"10rem"}}>
        <Row>
          <Col>
            <Col>
              <h1 className="" style={{color:"#043053"}}>{about.title}</h1>
              <p className="">
                {about.text}
              </p>
              <p>
                <strong style={{color:"#043053"}}>Ausbildung:</strong> {about.education}
              </p>
              <p>
                <strong style={{color:"#043053"}}>Erfahrung:</strong> {about.experience}
              </p>
